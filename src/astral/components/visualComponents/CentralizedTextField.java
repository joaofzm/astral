...
public class CentralizedTextField implements VisualComponent {
	...
	public CentralizedTextField(double y, double xSize, double ySize, String placeHolderText, int fontSize) {
